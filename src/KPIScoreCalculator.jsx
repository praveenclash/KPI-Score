...
function FinalPointCell({ value, onCopy }) {
  ...
  return (
    <div 
      ...
      title="Click to copy"
    >
      <span className={`font-semibold text-xs ${value > 0 ? "text-blue-600 dark:text-blue-400" : value < 0 ? "text-red-500 dark:text-red-400" : "text-gray-400 dark:text-gray-500"}`}>
        {value.toFixed(2)}
      </span>
      {showCopy && (
        <svg 
                    ...
                    filtered.map((r, i) => (
                      ...
                      >
                        ...
                        <td className="px-2 py-2 text-right">
                          <ScoreCell value={r.taskScore} onCopy={handleCopySuccess} />
                        </td>
                        <td className="px-2 py-2 text-right">
                          <ScoreCell value={r.onTimeScore} onCopy={handleCopySuccess} />
                        </td>
                        <td className="px-2 py-2 text-right">
                          {editingQuality === i ? (
                            ...
                            <div className="flex items-center justify-end gap-1">
                              ...
                              >
                                <ScoreCell value={r.qualityScore} onCopy={handleCopySuccess} />
                        ...
                        <td className="px-2 py-2 text-right">
                          <FinalPointCell value={r.finalPoint} onCopy={handleCopySuccess} />
                        </td>
                      </tr>
                    ))
                  )}
